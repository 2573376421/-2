...
//-------------------------------------------------------------------------------------------------------------------
void bluetooth_osc(uint16 d1, uint16 d2, uint16 d3, uint8 n)
{ 
    uint8 data_to_send[11];
 	data_to_send[0]=0xAA;
 	data_to_send[1]=0xAA;
 	if(n == 1)
 	data_to_send[2]=0xF1;
 	...
 	data_to_send[3]=6;
 	data_to_send[4]=d1>>8;
 	data_to_send[5]=d1%256;
 	data_to_send[6]=d2>>8;
 	data_to_send[7]=d2%256;
	data_to_send[8]=d3>>8;
 	data_to_send[9]=d3%256;
	sum = 0;
 	for(i=0;i<10;i++)
 	sum += data_to_send[i];
 	data_to_send[10] = sum;

 	uart_putbuff(UART_1,data_to_send,11);
}